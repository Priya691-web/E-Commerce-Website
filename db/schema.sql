...
('Admin User', 'admin@fashionstore.com', '$2a$10$xMyAFgotkz5F3hA665n8K.rlG1NExFLwjPhUKij4nZY/6y1dt/COC', '9876543210', 'Admin Office, FashionStore HQ', 'admin', TRUE, NOW());

-- Demo Customer Accounts (Password: demo123)
INSERT INTO users (full_name, email, password, phone, address, role, created_at) VALUES
('Sarah Johnson', 'sarah.demo@email.com', '$2a$10$5WYsPh8Llb6VWAt77M6C0elxxtY4ugzKcnWR8R.5i57giMMDleSf2', '9876543211', '123 Fashion Street, Mumbai, Maharashtra 400001', 'customer', NOW()),
('Rahul Sharma', 'rahul.demo@email.com', '$2a$10$5WYsPh8Llb6VWAt77M6C0elxxtY4ugzKcnWR8R.5i57giMMDleSf2', '9876543212', '456 Style Avenue, Delhi, 110001', 'customer', NOW()),
('Priya Patel', 'priya.demo@email.com', '$2a$10$5WYsPh8Llb6VWAt77M6C0elxxtY4ugzKcnWR8R.5i57giMMDleSf2', '9876543213', '789 Trend Boulevard, Bangalore, 560001', 'customer', NOW()),
('Arjun Kumar', 'arjun.demo@email.com', '$2a$10$5WYsPh8Llb6VWAt77M6C0elxxtY4ugzKcnWR8R.5i57giMMDleSf2', '9876543214', '321 Vogue Lane, Hyderabad, 500001', 'customer', NOW());
...
INSERT INTO user_settings (user_id, email_notifications, order_updates, language, currency, theme_preference, profile_visible, activity_tracking, third_party_sharing)
SELECT user_id, TRUE, TRUE, 'en', 'INR', 'auto', FALSE, TRUE, FALSE
FROM users;
...
-- ============================================================
-- 18. MIGRATION: Add privacy columns to existing user_settings
--    Run these ALTER statements on existing databases only
-- ============================================================
-- ALTER TABLE user_settings ADD COLUMN IF NOT EXISTS profile_visible BOOLEAN DEFAULT FALSE AFTER theme_preference;
-- ALTER TABLE user_settings ADD COLUMN IF NOT EXISTS activity_tracking BOOLEAN DEFAULT TRUE AFTER profile_visible;
-- ALTER TABLE user_settings ADD COLUMN IF NOT EXISTS third_party_sharing BOOLEAN DEFAULT FALSE AFTER activity_tracking;
