        ...
        <div class="account-layout">
            ...
            <div class="account-content">
                <section class="account-section">
                    ...
                    <form action="<%= request.getContextPath() %>/account/addresses" method="POST" class="form account-form">
                        ...
                        <div class="form-group <%= fieldErrors != null && fieldErrors.containsKey("addressType") ? "has-error" : "" %>">
                        ...
                        <div class="form-group <%= fieldErrors != null && fieldErrors.containsKey("addressLine1") ? "has-error" : "" %>">
                        ...
                        <div class="form-row">
                            <div class="form-group <%= fieldErrors != null && fieldErrors.containsKey("city") ? "has-error" : "" %>">
                            ...
                            <div class="form-group <%= fieldErrors != null && fieldErrors.containsKey("state") ? "has-error" : "" %>">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary"><%= isEdit ? "Update Address" : "Save Address" %></button>
                            <a href="<%= request.getContextPath() %>/account/addresses" class="btn btn-outline">Cancel</a>
                        </div>
                    </form>
                </section>
            </div>
