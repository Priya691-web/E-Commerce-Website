            ...
            <% for (WishlistItem item : wishlistItems) { %>
                <article class="product-card" id="wishlist-item-<%= item.getProductId() %>">
                    <div class="product-card__media">
                        ...
                        <button class="product-card__wishlist product-card__wishlist--active" data-product-id="<%= item.getProductId() %>" aria-label="Remove from wishlist" aria-pressed="true">
...
<script>
// Initialize wishlist buttons on wishlist page
