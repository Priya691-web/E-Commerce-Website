    ...
    <div class="container">
        <div class="success-container">
            ...
            <div class="success-actions">
                <a href="<%= request.getContextPath() %>/orders" class="fs-btn fs-btn--primary">View Orders</a>
                <a href="<%= request.getContextPath() %>/products" class="fs-btn fs-btn--outline">Continue Shopping</a>
            </div>
        </div>
    </div>
</main>
