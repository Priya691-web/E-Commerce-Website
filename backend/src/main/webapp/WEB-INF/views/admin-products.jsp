...
<script src="<%= request.getContextPath() %>/assets/js/modules/admin-products.js"></script>
</head>
...
<div id="imageModal" class="admin-modal" role="dialog" aria-modal="true" aria-labelledby="modalImageName">
    <div class="admin-modal__dialog">
        ...
        <img id="modalImage" class="admin-modal__img" src="" alt="Product preview" loading="lazy">
