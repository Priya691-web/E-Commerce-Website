...
public class JWTAuthenticationFilter implements Filter {
    ...
    /**
     * Public admin endpoints that do NOT require a JWT (all admin endpoints for demo).
     * Note: This field is deprecated as we now check all /api/admin paths in isPublicAdminPath
     */
    ...
    private boolean isPublicAdminPath(String path) {
        // Only allow specific public endpoints without JWT validation
        // Login, logout, me, register, refresh, and dashboard endpoints are public
        // These endpoints handle JWT authentication themselves
