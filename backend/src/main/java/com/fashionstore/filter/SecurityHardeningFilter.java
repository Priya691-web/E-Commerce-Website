...
public class SecurityHardeningFilter implements Filter {
    ...
    private void configureSessionCookies(HttpServletRequest request, HttpServletResponse response) {
        ...
        String secureFlagStr = isHttps ? "Secure" : "";
        String sameSiteValueStr = isHttps ? "Strict" : "Lax"; // Use Lax for HTTP development
        ...
        if (session != null && session.isNew()) {
            ...
            String cookieHeader = String.format(
                ...
                sessionId, secureFlagStr, sameSiteValueStr
            );
    ...
    private void applySecurityHeaders(HttpServletRequest request, HttpServletResponse response) {
        ...
        // Note: report-uri is deprecated and disabled in demo mode
        // Use report-to directive instead when CSP endpoint is available
