    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null) {
                ...
                String csrfToken = com.fashionstore.security.CSRFProtection.getCurrentToken(request);
                if (csrfToken == null) {
                    csrfToken = com.fashionstore.security.CSRFProtection.generateToken(request);
                }
                if (csrfToken != null) {
